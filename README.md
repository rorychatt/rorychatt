...
| Project | Stack | Description |
| :--- | :--- | :--- |
| **[open-apple-models](https://github.com/SpaceCorps/open-apple-models)** | Swift, Rust, Python | Agentic tool calling for Apple Foundation Models: Swift package, CLI, and OpenAI-compatible server for on-device AI, NPC dialogue, and autonomous decision-making on iOS, iPadOS, and macOS. |
| **[open-android-models](https://github.com/SpaceCorps/open-android-models)** | Kotlin, Rust, JNI | Agentic tool calling for Android's built-in Gemini Nano (AICore / ML Kit Prompt API): Kotlin library, NPC decision engine, and JSON-RPC protocol bridge over JNI. |
...
| Project | Stack | Description |
| :--- | :--- | :--- |
| **[Ivy-Framework](https://github.com/Ivy-Interactive/Ivy-Framework)** (434★) | C#, .NET 9, Roslyn, TypeScript | Full-stack framework for building internal web tools with LLM code generation. Unifies front-end and back-end in a single C# codebase with instant hot-reload. 1st founding engineer & core architect. |
